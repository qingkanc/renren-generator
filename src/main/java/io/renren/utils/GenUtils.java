...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/dbService.java.vm");
        templates.add("template/dbServiceImpl.java.vm");
...
//        templates.add("template/add-or-update.vue.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("dbService.java.vm")) {
            return packagePath + "service" + File.separator + className + "DbService.java";
        }
        if (template.contains("dbServiceImpl.java.vm")) {
            return packagePath + "service" + File.separator + className + "DbServiceImpl.java";
        }
...
//        }
//
//        if (template.contains("model.java.vm") || template.contains("MongoEntity.java.vm")) {
//            return packagePath + "entity" + File.separator + className + "Entity.java";
//        }
//
